...
CREATE TABLE CULTURA 
    ( 
     ...
     id_rotacao                 INTEGER  NOT NULL 
    ) 
;

ALTER TABLE CULTURA 
    ADD CONSTRAINT PK_CULTURA PRIMARY KEY ( id_cultura, id_rotacao ) ;

ALTER TABLE CULTURA 
    ADD CONSTRAINT UN_CULTURA UNIQUE ( id_cultura ) ;

CREATE TABLE EQUIPAMENTO_IRRIGACAO 
    ( 
...
ALTER TABLE EQUIPAMENTO_IRRIGACAO 
...
CREATE TABLE ROTACAO_CULTURA 
    ( 
     id_rotacao           INTEGER  NOT NULL , 
     tipo_rotacao_cultura VARCHAR2 (10 CHAR) , 
     nro_rotacao_cultura  INTEGER , 
     periodo_rotacao      UNKNOWN 
--  ERROR: Datatype UNKNOWN is not allowed 
                    
    ) 
;

ALTER TABLE ROTACAO_CULTURA 
    ADD CONSTRAINT PK_ROTACAO_CULTURA PRIMARY KEY ( id_rotacao ) ;
...
CREATE TABLE SENSOR_NPK 
    ( 
     ...
     timestamp_instalacao  TIMESTAMP WITH LOCAL TIME ZONE  NOT NULL , 
     timestamp_desativacao TIMESTAMP WITH LOCAL TIME ZONE  NOT NULL 
    ) 
;
...
ALTER TABLE CULTURA 
    ADD CONSTRAINT FK_CULTURA_ROTACAO_CULTURA FOREIGN KEY 
    ( 
     id_rotacao
    ) 
    REFERENCES ROTACAO_CULTURA 
    ( 
     id_rotacao
    ) 
;
...
ALTER TABLE IRRIGACAO 
    ...
    REFERENCES EQUIPAMENTO_IRRIGACAO 
    ( 
     id_irrigador
    ) 
;
